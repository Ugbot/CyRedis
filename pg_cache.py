"""
CyRedis PostgreSQL Read-Through Cache
...
def load_pgcache_module(redis_client, pg_config: Dict[str, Any]) -> bool:
    ...
    Args:
        redis_client: CyRedis client instance
    ...
    Example:
        >>> from cy_redis import HighPerformanceRedis, load_pgcache_module
    ...
    if not module_path:
        raise FileNotFoundError("pgcache Redis module not found. Make sure CyRedis is properly installed.")
