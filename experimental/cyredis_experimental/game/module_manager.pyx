...
cdef class CyGameModule:
    ...
    cpdef void load(self, str module_path=""):
        ...
        module_path defaults to experimental/cyredis_experimental/game/module/cy_game.so next to this file.
        ...
        if not os.path.exists(module_path):
            raise FileNotFoundError(
                ...
                "Build it first: make -C experimental/cyredis_experimental/game/module"
            )
        try:
