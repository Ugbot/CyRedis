...
async def require_ws_auth(websocket, token: str):
    ...
    Validates *token* using :class:`~cyredis_experimental.web.web_app_support.WebAppSupport`
    ...
    Wire it up like this::
        ...
        from cyredis_experimental.web.fastapi_integration import require_ws_auth
