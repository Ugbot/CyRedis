...
try:
    ...
    from cyredis_experimental.web.web_app_support import (
        WebAppSupport as WebApplicationSupport,
    )
...
class TestWorkerIDGeneration:
    ...
    def test_worker_id_format(self):
        ...
        with (
            patch("cyredis_experimental.workers.lifecycle_manager.os") as mock_os,
            patch("cyredis_experimental.workers.lifecycle_manager.socket") as mock_socket,
        ):
